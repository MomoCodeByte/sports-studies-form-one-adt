# Sport Studies for Secondary Schools: Student's Book Form One — ADT Bundle Reference
...
**Sport Studies for Secondary Schools: Student's Book Form One** — This book is an English-language Sport Studies textbook for Form One secondary students in Tanzania, roughly aimed at lower secondary or early teen learners. It introduces the foundations of physical education through topics such as sport concepts, safety and injury prevention, fitness, football, and track events, while connecting sport to health, science, and everyday life. Published by the Tanzania Institute of Education, it reflects a competency-based, practical teaching approach with activities, exercises, projects, and portfolio work that promote active lifestyles, skill development, discipline, and overall physical, mental, and social well-being.

- **Source language**: `en-US`
- **Available languages in this bundle**: `en-US`, `en-KE`
- **Total pages**: 105
- **Quizzes**: yes
- **Glossary**: yes
...
│   │   └── i18n/
│   │       └── {lang}/               # One directory per language: en-US, en-KE
...
├── SPORTS-STUDIES-FORM-ONE.db                    # SQLite database (pipeline state)
├── SPORTS-STUDIES-FORM-ONE.pdf                   # Original source PDF
...
{
  "pg001_gp001_tx001": "",
  "pg001_im001": "Certificate of Approval from the United Republic of Tanzania Ministry of Education, Science and Technology for Sport Studies for Secondary Schools Student’s Book Form One. It shows approval number 1186 and a signature by the Commissioner for Education.",
  "gl001": "accelerate",
  "gl001_def": "to increase speed and move faster.",
  "qz001_que": "What is the major vehicle of Sport Studies?",
  "qz001_o0": "1) Music",
  "qz001_o0_exp": "❌ Not correct. Music is not described as the main vehicle of Sport Studies in the text."
}
```
...
```json
{
  "accelerate": {
    "word": "accelerate",
    "definition": "to increase speed and move faster.",
    "variations": ["accelerate","accelerates","accelerated","accelerating","acceleration"],
    "emoji": "⚡🏃"
  }
}
```
...
<section role="activity" data-section-type="activity_quiz" data-id="qz001"
    ...
    <p data-id="qz001_que">What is the major vehicle of Sport Studies?</p>

    <label data-activity-item="qz001_o0"
           data-explanation="❌ Not correct. Music is not described as the main vehicle of Sport Studies in the text." data-explanation-id="qz001_o0_exp">
        <input type="radio" name="qz001" value="qz001_o0" class="sr-only" />
        <span data-id="qz001_o0">1) Music</span>
    </label>
    <!-- more options... -->
</section>
...
| Original PDF | `SPORTS-STUDIES-FORM-ONE.pdf` |
| Pipeline database | `SPORTS-STUDIES-FORM-ONE.db` (SQLite) |
